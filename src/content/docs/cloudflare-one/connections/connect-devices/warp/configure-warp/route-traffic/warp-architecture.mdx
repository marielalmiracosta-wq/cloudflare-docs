...
resolver #1
  search domain[1] : <DNS-SEARCH-DOMAIN>
  nameserver[1] : 127.0.2.2
...
resolver #2
  nameserver[1] : 127.0.2.2
  nameserver[1] : 127.0.2.3
  nameserver[1] : fd01:db8:1111::2
  nameserver[1] : fd01:db8:1111::3
  if_index : 23 (utun3)
...
Unknown adapter CloudflareWARP:
   ...
   IPv6 Address. . . . . . . . . . . : 2606:4700:110:8f79:145:f180:fc4:8106
   Link-local IPv6 Address . . . . . : fe80::83b:d647:4bed:d388%49
...
S -- Yes --> A[(Application)]
S -- Yes --> U["Virtual interface<br> (172.16.0.2)"] --> G[Cloudflare Gateway]
```
